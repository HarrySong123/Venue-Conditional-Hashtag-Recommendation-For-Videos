...
model.fit_generator(generate_arrays_from_file_train(),epochs=60,steps_per_epoch=lentrain,callbacks=[keras.callbacks.TerminateOnNaN()],validation_data=generate_arrays_from_file_validation(), validation_steps=lenvalidation)    
